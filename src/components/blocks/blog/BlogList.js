                        ...
                        <div className="row g-4">
                                ...
                                <div className="blog-box blog-list wow fadeInUp">
                                    ...
                                    <div className="blog-contain blog-contain-2">
                                        ...
                                        <button onclick="location.href = 'blog-detail.html';" className="blog-button">Read
                                            More <i className="fa-solid fa-right-long"></i></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-12">
                                <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.1s">
                                    <div className="blog-image">
                                        <a href="blog-detail.html">
                                            <img src="../assets/images/inner-page/blog/3.jpg" className="blur-up lazyload"
                                                alt="" />
                                        </a>
                            ...
                            <div className="col-12">
                                <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.15s">
                                    <a href="blog-detail.html" className="blog-image">
                                        <img src="../assets/images/inner-page/blog/4.jpg" className="blur-up lazyload" alt="" />
                                    </a>
