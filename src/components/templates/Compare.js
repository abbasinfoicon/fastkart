                            ...
                            <table className="table compare-table">
                                <tbody>
                                    <tr>
                                        <th>Product</th>
                                        <td>
                                            <a className="text-title" href="product-left-thumbnail.html">Daily Shine Shampoo</a>
                                        </td>
                                        <td>
                                            <a className="text-title" href="product-left-thumbnail.html">Intence Repair
                                                Shampoo</a>
                                        </td>
                                        <td>
                                            <a className="text-title" href="product-left-thumbnail.html">Anti Dandruff
                                                Solution</a>
                                        </td>
                                        <td>
                                            <a className="text-title" href="product-left-thumbnail.html">Repair & Shine
                                                Shampoo</a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>Images</th>
                                        <td>
                                            <a href="product-left-thumbnail.html" className="compare-image">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="location.href = 'cart.html';"
                                                className="btn btn-animation btn-sm w-100">Add To Cart</button>
                                        </td>
                                        <td>
                                            <button onclick="location.href = 'cart.html';"
                                                className="btn btn-animation btn-sm w-100">Add To Cart</button>
                                    ...
                                    <tr>
                                        <th></th>
                                        <td>
                                            <a href="javascript:void(00" className="text-content remove_column"><i
                                                className="fa-solid fa-trash-can me-2"></i> Remove</a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(00" className="text-content remove_column"><i
                                                className="fa-solid fa-trash-can me-2"></i> Remove</a>
