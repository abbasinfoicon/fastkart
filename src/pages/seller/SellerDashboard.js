                    ...
                    <div className="dashboard-bg-box">
                      ...
                      <div className="privacy-box">
                        <div
                          ...
                          <input className="form-check-input" type="radio" id="desktop" name="desktop"
                            checked />
                          <label className="form-check-label ms-2" for="desktop">Show
                      ...
                      <div className="privacy-box">
                        <div
                          ...
                          <label className="form-check-label ms-2" for="enable">Enable
                            Notifications</label>
                        </div>
                      </div>
                      ...
                      <div className="privacy-box">
                        <div
                          ...
                          <input className="form-check-input" type="radio" id="activity"
                            name="desktop" />
                          <label className="form-check-label ms-2" for="activity">Get
                      ...
                      <div className="privacy-box">
                        <div
                          ...
                          <label className="form-check-label ms-2" for="dnd">DND</label>
                        </div>
                      </div>
                      ...
                      <div className="privacy-box">
                        <div
                          ...
                          <input className="form-check-input" type="radio" id="concern"
                            name="concern" />
                          <label className="form-check-label ms-2" for="concern">I have a privacy
                            concern</label>
                        </div>
                      </div>
                      <div className="privacy-box">
                        <div
                          ...
                          <input className="form-check-input" type="radio" id="temporary"
                            name="concern" />
                          <label className="form-check-label ms-2" for="temporary">This is
                            temporary</label>
                        </div>
                      </div>
                      <div className="privacy-box">
                        <div
                          ...
                          <label className="form-check-label ms-2" for="other">other</label>
                        </div>
                      </div>
                    ...
                    <div className="dashboard-bg-box">
                      ...
                      <div className="privacy-box">
                        <div
                          ...
                          <label className="form-check-label ms-2" for="usable">No longer
                            usable</label>
                        </div>
                      </div>
                      <div className="privacy-box">
                        <div
                          ...
                          <label className="form-check-label ms-2" for="account">Want to switch on
                            other
                            account</label>
                        </div>
                      </div>
                      <div className="privacy-box">
                        <div
                          ...
                          <label className="form-check-label ms-2" for="other-2">Other</label>
                        </div>
                      </div>
