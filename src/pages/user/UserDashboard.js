            ...
            <div className="col-xxl-9 col-lg-8">
              ...
              <div className="dashboard-right-sidebar">
                <div className="tab-content" id="pills-tabContent">
                  ...
                  <div className="tab-pane fade show" id="pills-address" role="tabpanel"
                      ...
                      <div className="title title-flex">
                        ...
                        <button className="btn theme-bg-color text-white btn-sm fw-bold mt-lg-0 mt-3"
                          data-bs-toggle="modal" data-bs-target="#editCard"><i data-feather="plus"
                            className="me-2"></i> Add New Card</button>
                      </div>
                          ...
                          <div className="payment-card-detail">
                            ...
                            <div className="edit-card">
                              <a data-bs-toggle="modal" data-bs-target="#editCard"
                                href="javascript:void(0)"><i className="far fa-edit"></i> edit</a>
                              <a href="javascript:void(0)" data-bs-toggle="modal"
