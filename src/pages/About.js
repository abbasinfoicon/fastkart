...
import Breadscrumb from '../components/blocks/Breadscrumb'
            ...
            <div className="col-12">
              ...
              <div className="slider-3_1 product-wrapper">
                <div>
                  <div className="clint-contain">
                    <div className="client-icon">
                      <img src="https://themes.pixelstrap.com/fastkart/assets/svg/3/work.svg" className="blur-up lazyload" alt="" />
                    </div>
                    <h2>10</h2>
                ...
                <div>
                  <div className="clint-contain">
                    <div className="client-icon">
                      <img src="https://themes.pixelstrap.com/fastkart/assets/svg/3/buy.svg" className="blur-up lazyload" alt="" />
                    </div>
                    <h2>80 K+</h2>
                ...
                <div>
                  <div className="clint-contain">
                    <div className="client-icon">
                      <img src="https://themes.pixelstrap.com/fastkart/assets/svg/3/user.svg" className="blur-up lazyload" alt="" />
                    </div>
                    <h2>90%</h2>
              ...
              <div className="slider-4-half product-wrapper">
                ...
                <div>
                  <div className="reviewer-box">
                    ...
                    <div className="reviewer-profile">
                      <div className="reviewer-image">
                        <img src="../assets/images/inner-page/user/2.jpg" className="blur-up lazyload"
                          alt="" />
                      </div>
                ...
                <div>
                  <div className="reviewer-box">
                    ...
                    <div className="reviewer-profile">
                      <div className="reviewer-image">
                        <img src="../assets/images/inner-page/user/4.jpg" className="blur-up lazyload"
                          alt="" />
                      </div>
              ...
              <div className="slider-5 ratio_87">
                    ...
                    <div className="blog-box-image">
                      <div className="blog-image">
                        <a href="blog-detail.html" className="rounded-3">
                          <img src="../assets/images/veg-2/blog/1.jpg" className="bg-img blur-up lazyload"
                            alt="" />
                        </a>
                      </div>
                    </div>
                ...
                <div>
                  <div className="blog-box">
                    <div className="blog-image">
                      <a href="blog-detail.html" className="rounded-3">
                        <img src="../assets/images/veg-2/blog/5.jpg" className="bg-img blur-up lazyload"
                          alt="" />
                      </a>
                    </div>
